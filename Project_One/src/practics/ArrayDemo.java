...
/********************************************************
 *
 * This program demonstrate the concept of Array 1. Array is a fixed length data
 * Structure used to hold more than one value 2.
 *
 *
 ********************************************************/
...
public class ArrayDemo {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < arr1.length; i++) // if we do not have the size of array we can get it with the helpo of
												// length.
		{
